...
public class AddAdmin extends NameException implements ActionListener{
   ...
   Font basic=new Font("Arial",Font.PLAIN,16);
    ...
    AddAdmin(){
        ...
        ConfirmPasswordField.setBounds(500,570,400,30);
        ...
        AddAdminButton.setBounds(600,600,150,40);
        ...
        ForgetButton.setBounds(450,650,400,30);
        ...
        panel1.setBackground(new Color(56,179,230));
